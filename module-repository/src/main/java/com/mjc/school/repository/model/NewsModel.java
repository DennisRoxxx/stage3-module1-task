...
public class NewsModel {
    ...
    public boolean equals(Object o) {
        ...
        return id.equals(newsModel.id)
                && title.equals(newsModel.title)
                && content.equals(newsModel.content)
                && createDate.equals(newsModel.createDate)
                && lastUpdateDate.equals(newsModel.lastUpdateDate)
                && authorId.equals(newsModel.authorId);
    }
