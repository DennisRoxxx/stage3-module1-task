...
public class NewsDtoResponse {
    ...
    public boolean equals(Object o) {
        ...
        NewsDtoResponse response = (NewsDtoResponse) o;
        return id.equals(response.id)
                && title.equals(response.title)
                && content.equals(response.content)
                && createDate.equals(response.createDate)
                && lastUpdateDate.equals(response.lastUpdateDate)
                && authorId.equals(response.authorId);
    }
